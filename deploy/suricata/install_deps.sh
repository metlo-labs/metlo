...
sudo cp /home/$WHOAMI/suricata/local.rules /var/lib/suricata/rules/local.rules -f
...
sudo cp /home/$WHOAMI/suricata/suricata.yaml /etc/suricata/suricata.yaml -f
...
echo "ADDING SERVICE"
sudo mv /home/$WHOAMI/suricata/metlo-ingestor.service /lib/systemd/system/metlo-ingestor.service -f
