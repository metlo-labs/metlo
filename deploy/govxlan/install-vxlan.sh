...
sudo curl -L https://raw.githubusercontent.com/metlo-labs/metlo/govxlan_pcap/deploy/govxlan/metlo-traffic-mirror-vxlan.service > /home/$WHOAMI/metlo/metlo-traffic-mirror.service
